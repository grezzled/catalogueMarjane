            ...
            {articles.map((article) => (
              ...
              >
                <div className="flex items-center gap-2 mb-3 flex-wrap">
                  ...
                  <span className="text-[11px] font-medium text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full whitespace-nowrap shrink-0">
                    {article.primaryKeyword || "Conseil"}
                  </span>
                  {article.publishedAt && (
                    <span className="text-xs text-gray-400 flex items-center gap-1 whitespace-nowrap shrink-0">
