  ...
  function renderActions(c: Catalogue) {
    ...
    return (
      <>
        ...
        {(isDone || isRunning || isFailed) && (
          <ActionButton onClick={() => handleControl(c.id, "restart", "Delete all pages/products and re-extract from the PDF?")} color="bg-orange-100 text-orange-700 hover:bg-orange-200" loading={busy}>
            Restart
          </ActionButton>
        )}
