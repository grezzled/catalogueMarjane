              ...
              {categories.map((cat) => {
                ...
                return (
                  <Link
                    ...
                    className="flex flex-col items-center gap-2 bg-white border border-gray-200 rounded-xl p-5 text-center hover:border-red-300 hover:bg-red-50 transition-all font-medium text-gray-700 hover:text-red-600"
                  >
